  ...
  <div className="p-3 bg-white shadow-sm rounded mb-4" data-aos="fade-up" data-aos-duration="1000">
    ...
    <Row className="g-2">
      <Col xs={12} md={6} data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
        <Button variant="outline-dark" className="w-100 d-flex align-items-center gap-2 justify-content-center" onClick={() => navigate('/home/ask-ai')}>
          <FaRobot /> Ask AI
        </Button>
      </Col>
      <Col xs={12} md={6} data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
        <Button variant="outline-dark" className="w-100 d-flex align-items-center gap-2 justify-content-center" onClick={() => navigate('/home/my-courses')}>
          <List /> My Courses
        </Button>
      </Col>
      <Col xs={12} md={6} data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
        <Button variant="outline-dark" className="w-100 d-flex align-items-center gap-2 justify-content-center" onClick={() => navigate('/home/course-catalog')}>
          <FaBookOpen /> Browse Courses
        </Button>
      </Col>
      <Col xs={12} md={6} data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000" onClick={() => navigate('/home/progress')}>
